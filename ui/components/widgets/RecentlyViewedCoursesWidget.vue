    ...
    <div v-else-if="recentCourses.length > 0" class="space-y-3">
        ...
        >
            ...
            <div class="flex-1 min-w-0">
                <h4 class="text-sm font-medium text-gray-900 dark:text-white truncate group-hover:text-vikinger-purple transition-colors">
                    {{ course.name }}
                </h4>
             ...
             <div class="flex items-center justify-center text-gray-400 group-hover:text-vikinger-purple group-hover:translate-x-1 transition-all">
