    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-8">
        <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center shadow-lg">
          <Icon name="mdi:hand-coin-outline" class="w-10 h-10 text-white" />
        </div>
      ...
      <BaseCard class="text-center py-12">
        <Icon name="mdi:clock-outline" class="w-16 h-16 mx-auto text-amber-500 mb-4" />
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
          เร็วๆ นี้
        </h2>
        <p class="text-gray-600 dark:text-gray-400">
          ระบบสะสมแต้มกำลังอยู่ระหว่างการพัฒนา กรุณารอติดตามการอัปเดต
        </p>
      </BaseCard>
    </div>
  </div>
